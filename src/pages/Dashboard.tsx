...
export default function Home() {
  ...
  return (
    <div
      className={`scriptora-workspace-shell scriptora-feature-page scriptora-os-ecosystem relative${
        workspaceSnapshot.state === "empty" && !activeWorkspaceTool ? " scriptora-postload-backdrop" : ""
      }`}
    >
