                      ...
                      {groupCards.map(card => {
                        ...
                        const inner = (
                          <button
                            ...
                            className="scriptora-world-module group relative flex min-h-[138px] min-w-[250px] max-w-[250px] shrink-0 flex-col overflow-hidden rounded-[18px] border border-white/10 bg-slate-950/32 p-3 text-left ring-1 ring-white/[0.03] transition duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 motion-safe:hover:-translate-y-0.5"
                          >
