...
export const BOOK_TYPE_REGISTRY: BookTypeDefinition[] = [
  ...
  { id: "children", label: "Bambini/Ragazzi", family: "narrative", genre: "children", subcategoryHints: ["bambini", "ragazzi", "children", "kids"], chapterStyle: "narrative", defaultSubchapters: true, titleMode: "contextual" },
  { id: "fairy-tale", label: "Fiaba", family: "narrative", genre: "fairy-tale", subcategoryHints: ["fiaba", "favola", "fairy"], chapterStyle: "narrative", defaultSubchapters: true, titleMode: "contextual" },
  // Non fiction
  ...
  { id: "memoir", label: "Memoir", family: "nonfiction", genre: "memoir", subcategoryHints: ["memoir", "autobiografia", "memorie"], chapterStyle: "lesson", defaultSubchapters: true, titleMode: "contextual" },
  { id: "biography", label: "Biografia", family: "nonfiction", genre: "biography", subcategoryHints: ["biografia", "biography"], chapterStyle: "lesson", defaultSubchapters: true, titleMode: "contextual" },
