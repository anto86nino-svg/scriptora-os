...
export function trustDestroyerRegistry(): TrustDestroyerItem[] {
  ...
  return [
    ...
    },
    {
      ...
      level: 4,
      area: "commercial",
      status: paymentsLive ? "fixed" : "mitigated",
      path: "src/components/UpgradeModal.tsx",
      description: paymentsLive
        ? "Pagamenti live via env."
        : "CTA mostra 'Avvisami al lancio' quando pagamenti non attivi.",
    },
    {
    ...
    },
    {
      ...
      description: "CoverGenerator lazy-loaded; export libs restano on-demand.",
    },
    {
      ...
      description: "Sync fallita marca stato pending/offline via callback.",
    },
    {
      ...
      description: "Score parte da 88 con euristiche — rischio percezione 'finto'.",
    },
    {
      ...
      area: "writing",
      status: "mitigated",
      path: "src/lib/primary-book-path.ts",
      description: "Wizard principale → /app; Auto Bestseller etichettato come scorciatoia.",
    },
    {
