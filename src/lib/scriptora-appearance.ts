...
export const SCRIPTORA_BACKGROUNDS: Array<{ id: ScriptoraBackgroundId; name: string; description: string; css: string; }> = [
  ...
  { id: "storm-library", name: "🌧 Rain Library", description: "Blu-grigio, thriller, tensione e lucidità.", css: "radial-gradient(circle at top, rgba(59,130,246,.18), transparent 32%), linear-gradient(135deg, #0f172a 0%, #111827 48%, #020617 100%)" },
  { id: "moonlit-paper", name: "🌕 Moonlight Paper", description: "Chiaro, freddo, pulito, adatto a lunghe sessioni.", css: "linear-gradient(135deg, #e5e7eb 0%, #cbd5e1 45%, #f8fafc 100%)" },
  ...
  { id: "golden-desk", name: "🔥 Golden Writing Desk", description: "Caldo, creativo, editoriale.", css: "radial-gradient(circle at 35% 10%, rgba(234,179,8,.25), transparent 32%), linear-gradient(135deg, #1f1605 0%, #3f2f0a 50%, #090605 100%)" },
